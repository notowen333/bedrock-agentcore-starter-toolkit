...
def dev(
    ...
    console.print("[cyan]ℹ️  This terminal window will be used to run the dev server [/cyan]")
    console.print('[cyan]💡 Test your agent with: agentcore invoke --dev "Hello"[/cyan] in a new terminal window')
